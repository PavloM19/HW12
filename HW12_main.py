...
if __name__ == "__main__":
    ...
    # print(list(AB.data))
    # print('Ада Ющенко' in AB.data)
    # AB.change_name('Ада Ющенко', 'QQQQQQQQQQ')
    # print(AB['QQQQQQQQQQ'])
    # print(AB['Ада Ющенко'].days_to_birthday())
    # print(AB.find_name('ще'))
    # print(AB.find_phone('06'))
...
# if __name__ == "__main__":
    ...
    # print(AB['Bill'].__dict__)
    # print(list(AB['John'].__dict__.values()))

    # print(AB.__dict__)
    # print(type(AB.data[any]))
    # print(list(AB.data[list(AB.data)[0]].__dict__))
    # print(list(AB.data)[0])
    # print(len(AB))
    # for k, v in AB.items():
    #     print(v)

    # sort_AB = sort_dict(AB.data)
    # print(type(sort_AB))
    # field_names1 = list(AB.data[list(AB.data)[0]].__dict__)
    # print(field_names1)
    # field_names2 = list(sort_AB[list(sort_AB)[0]].__dict__)
    # print(field_names2)
    # print(sort_AB[list(sort_AB)[0]].__dict__.values())

    # path_file = Path(__file__).parent / 'AddressBook.csv'
    # AB = read_AB(path_file)
    # pf = Path(__file__).parent / 'AddressBook_w.csv'
    # write_AB(pf, AB)

    # print('AB: ', AB)
    # print(type(AB))
    # print(AB.__dict__)
    # print(AB['Ада Ющенко'].__dict__)
    # for k in AB.data:
    #     print(k)
    # AB.show_all_names()
